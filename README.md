...
A comprehensive Django-based e-commerce platform specializing in computer hardware and components. PC-Land provides a
full-featured shopping experience with product management, cart management, order processing, payment integration, and
customer support.
...
PC-Land is a modern e-commerce platform designed for buying and selling computer hardware components. It features a
user-friendly interface, robust product catalog with advanced search capabilities powered by Elasticsearch, multiple
payment gateway integrations, and comprehensive customer support through a ticketing system.

The platform supports Persian (Farsi) language and Iranian localization, including Iranian cities, local payment
methods, and national identification support.
